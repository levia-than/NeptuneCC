...
void neptuneir_build_halide_kernels() {
  ...
  Halide::Expr v12 = Halide::operator-(v8, 1);
  Halide::Expr v13 = std::invoke(v4, v6, v7, v12);
  Halide::Expr v14 = v11 + v13;
  Halide::Expr v15 = Halide::operator+(v8, 1);
  Halide::Expr v16 = std::invoke(v4, v6, v7, v15);
  ...
  Halide::Expr v24 = Halide::operator-(v6, 1);
  Halide::Expr v25 = std::invoke(v4, v24, v7, v8);
  Halide::Expr v26 = v23 + v25;
  Halide::Expr v27 = Halide::operator+(v6, 1);
  Halide::Expr v28 = std::invoke(v4, v27, v7, v8);
  Halide::Expr v29 = v26 + v28;
  Halide::FuncRef v30 = std::invoke(v5, v6, v7, v8);
  neptune_halide::assign(v30, v29);
  neptune_halide::schedule_3d(v5, 8, 16, 8, 1, 2, 2, 1, 8);
