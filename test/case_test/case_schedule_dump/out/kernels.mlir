module {
  func.func @k0(%arg0: memref<8x8xi32>, %arg1: memref<8x8xi32>) attributes {neptunecc.block_begin_offset = 177 : i64, neptunecc.block_end_offset = 367 : i64, neptunecc.dm = "da", neptunecc.in = "x:ghosted", neptunecc.name = "k0", neptunecc.out = "y:owned", neptunecc.port_map = ["x=in0:ghosted:arg0", "y=out0:owned:arg1"], neptunecc.pragma_begin_offset = 111 : i64, neptunecc.pragma_end_offset = 384 : i64, neptunecc.tag = "k0"} {
