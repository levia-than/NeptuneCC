...
INPUT_MLIR=${1:-/home/wyx/project/NeptuneCC/test/smoke_tests/smoke.mlir}

WORKDIR=${WORKDIR:-/tmp/neptune_smoke}
mkdir -p "$WORKDIR"
cd "$WORKDIR"
...
int main() {
  ...
  // 你 runtime 里 malloc 出来的解在 r.aligned
